...
public class LicenciaRemota {
    ...
    public static EstadoLicencia consultarLicenciaRemota(String discoId) {
        EstadoLicencia estado = consultarPorDisco(discoId);

        if (estado == null) {
            System.out.println("🔄 No se pudo obtener licencia remota, se usará validación local.");
            return null;
        }

        // En el futuro: validar si el estado coincide con clave mensual, prueba, etc.
        return estado;
    }
