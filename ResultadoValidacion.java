...
public class ResultadoValidacion {
    ...
    public static ResultadoValidacion valido(TipoLicencia tipo, int diasRestantes) {
        return new ResultadoValidacion(true, tipo, diasRestantes, false, "Licencia válida");
    }
    
    public static ResultadoValidacion enGracia(TipoLicencia tipo, int diasGracia) {
        return new ResultadoValidacion(true, tipo, 0, true, 
            "En período de gracia: " + diasGracia + " días restantes");
    }
    
    public static ResultadoValidacion vencido(String mensaje) {
        return new ResultadoValidacion(false, null, 0, false, mensaje);
    }
    ...
    private ResultadoValidacion(boolean valido, TipoLicencia tipo, int diasRestantes, 
                               boolean enGracia, String mensaje) {
        this.valido = valido;
        this.tipo = tipo;
